...
impl<'a> DataDecl<'a> {
    ...
    pub fn variants(&self) -> Option<VariantItems<'a>> {
        self.0.children.iter().find_map(|c| match c {
            SyntaxElement::Node(n) => VariantItems::cast(n),
            _ => None,
        })
    }
}

pub struct VariantItems<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for VariantItems<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::VARIANT_ITEMS).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
...
impl<'a> UseDecl<'a> {
    ...
    pub fn rest(&self) -> impl Iterator<Item = UseSegment<'a>> + 'a {
        self.0.children.iter().filter_map(|c| match c {
            SyntaxElement::Node(n) => UseSegment::cast(n),
            _ => None,
        })
    }
    pub fn tree(&self) -> Option<UseTree<'a>> {
        self.0.children.iter().find_map(|c| match c {
...
pub struct UseSegment<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for UseSegment<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::USE_SEGMENT).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}

impl<'a> UseSegment<'a> {
    pub fn seg(&self) -> Option<&'a LosslessToken> {
        self.0.children.iter().find_map(|c| match c {
            SyntaxElement::Token(t) if t.kind == SyntaxKind::IDENT => Some(t),
            _ => None,
        })
...
impl<'a> UseTree<'a> {
    pub fn names(&self) -> Option<UseTreeNames<'a>> {
        self.0.children.iter().find_map(|c| match c {
            SyntaxElement::Node(n) => UseTreeNames::cast(n),
            _ => None,
        })
    }
}

pub struct UseTreeNames<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for UseTreeNames<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::USE_TREE_NAMES).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
...
pub struct CapItems<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for CapItems<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::CAP_ITEMS).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
...
impl<'a> AstNode<'a> for Expr<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        None
            ...
            .or_else(|| CtorExpr::cast(node).map(Self::CtorExpr))
            .or_else(|| ThunkExpr::cast(node).map(Self::ThunkExpr))
            .or_else(|| RollExpr::cast(node).map(Self::RollExpr))
            ...
            .or_else(|| ApplyExpr::cast(node).map(Self::ApplyExpr))
            .or_else(|| LetExpr::cast(node).map(Self::LetExpr))
            .or_else(|| MatchExpr::cast(node).map(Self::MatchExpr))
            .or_else(|| UnrollExpr::cast(node).map(Self::UnrollExpr))
...
pub struct CtorExpr<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for CtorExpr<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::CTOR_EXPR).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
...
impl<'a> CtorExpr<'a> {
    ...
    pub fn ctor_args(&self) -> Option<CtorArgs<'a>> {
        self.0.children.iter().find_map(|c| match c {
            SyntaxElement::Node(n) => CtorArgs::cast(n),
            _ => None,
        })
    }
}

pub struct CtorArgs<'a>(pub(crate) &'a SyntaxNode);
...
pub struct CtorArgItems<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for CtorArgItems<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::CTOR_ARG_ITEMS).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
...
pub struct RollExpr<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for RollExpr<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::ROLL_EXPR).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
...
impl<'a> LambdaExpr<'a> {
    pub fn param(&self) -> Option<&'a LosslessToken> {
        self.0.children.iter().find_map(|c| match c {
            SyntaxElement::Token(t) if t.kind == SyntaxKind::IDENT => Some(t),
            _ => None,
        })
...
pub struct ApplyExpr<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for ApplyExpr<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::APPLY_EXPR).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
...
pub struct UnrollExpr<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for UnrollExpr<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::UNROLL_EXPR).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
...
impl<'a> MemberExpr<'a> {
    ...
    pub fn field(&self) -> Option<&'a LosslessToken> {
        self.0.children.iter().find_map(|c| match c {
            SyntaxElement::Token(t) if t.kind == SyntaxKind::IDENT => Some(t),
            _ => None,
        })
...
pub struct PatternFieldItems<'a>(pub(crate) &'a SyntaxNode);

impl<'a> AstNode<'a> for PatternFieldItems<'a> {
    fn cast(node: &'a SyntaxNode) -> Option<Self> {
        (node.kind == SyntaxKind::PATTERN_FIELD_ITEMS).then(|| Self(node))
    }
    fn syntax(&self) -> &'a SyntaxNode { self.0 }
}
