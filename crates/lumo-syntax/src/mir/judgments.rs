...
pub fn rules() -> Vec<Rule> {
    vec![
        ...
        Rule {
            judgment: "check_C".to_owned(),
            params: vec![app("TryC", vec![var(0), var(1)]), app("FTypeC", vec![var(2), var(3)]), var(4)],
            var_count: 5,
            body: vec![
                Goal::Call { judgment: "check_C".to_owned(), args: vec![var(1), app("FTypeC", vec![var(2), var(3)]), var(4)], extends: vec![("Γ".to_owned(), var(0), var(2))] },
            ],
        },
        Rule {
            judgment: "check_C".to_owned(),
            params: vec![app("AbortC", vec![var(0), var(1)]), var(2), var(3)],
            var_count: 6,
            body: vec![
                Goal::CtxRead { ctx: "Γ".to_owned(), key: var(0), value: var(5) },
                Goal::Unify(var(4), var(5)),
                Goal::Call { judgment: "check_V".to_owned(), args: vec![var(1), var(4)], extends: vec![] },
            ],
        },
        Rule {
            judgment: "check_C".to_owned(),
        ...
        Rule {
            judgment: "infer_C".to_owned(),
            params: vec![app("TryC", vec![var(0), var(1)]), var(2), var(3)],
            var_count: 6,
            body: vec![
                Goal::Unify(var(2), app("FTypeC", vec![var(4), var(5)])),
                Goal::Call { judgment: "infer_C".to_owned(), args: vec![var(1), app("FTypeC", vec![var(4), var(5)]), var(3)], extends: vec![("Γ".to_owned(), var(0), var(4))] },
            ],
        },
        Rule {
            judgment: "infer_C".to_owned(),
...
pub fn term_of(node: &SyntaxNode) -> Term {
    match node.kind {
        ...
        SyntaxKind::COMP_POSTFIX => app("CompPostfix", vec![match langue_rt::nth_node_in(node, &[SyntaxKind::ABORT_C, SyntaxKind::CASE_C, SyntaxKind::COMP_POSTFIX, SyntaxKind::FIX_C, SyntaxKind::FORCE_C, SyntaxKind::HANDLE_C, SyntaxKind::LAM_C, SyntaxKind::LET_C, SyntaxKind::PAREN_C, SyntaxKind::PERFORM_C, SyntaxKind::RET_C, SyntaxKind::SEL_C, SyntaxKind::TRY_C], 0) { Some(n) => term_of(n), None => atom("#none") }, match langue_rt::nth_node_in(node, &[SyntaxKind::VALUE_ARGS], 0) { Some(n) => term_of(n), None => atom("#none") }]),
        ...
        SyntaxKind::LET_C => app("LetC", vec![match langue_rt::nth_token_of(node, SyntaxKind::IDENT, 0) { Some(t) => atom(t.text.clone()), None => atom("#none") }, match langue_rt::nth_node_in(node, &[SyntaxKind::ABORT_C, SyntaxKind::CASE_C, SyntaxKind::COMP_POSTFIX, SyntaxKind::FIX_C, SyntaxKind::FORCE_C, SyntaxKind::HANDLE_C, SyntaxKind::LAM_C, SyntaxKind::LET_C, SyntaxKind::PAREN_C, SyntaxKind::PERFORM_C, SyntaxKind::RET_C, SyntaxKind::SEL_C, SyntaxKind::TRY_C], 0) { Some(n) => term_of(n), None => atom("#none") }, match langue_rt::nth_node_in(node, &[SyntaxKind::ABORT_C, SyntaxKind::CASE_C, SyntaxKind::COMP_POSTFIX, SyntaxKind::FIX_C, SyntaxKind::FORCE_C, SyntaxKind::HANDLE_C, SyntaxKind::LAM_C, SyntaxKind::LET_C, SyntaxKind::PAREN_C, SyntaxKind::PERFORM_C, SyntaxKind::RET_C, SyntaxKind::SEL_C, SyntaxKind::TRY_C], 1) { Some(n) => term_of(n), None => atom("#none") }]),
        ...
        SyntaxKind::TRY_C => app("TryC", vec![match langue_rt::nth_token_of(node, SyntaxKind::IDENT, 0) { Some(t) => atom(t.text.clone()), None => atom("#none") }, match langue_rt::nth_node_in(node, &[SyntaxKind::ABORT_C, SyntaxKind::CASE_C, SyntaxKind::COMP_POSTFIX, SyntaxKind::FIX_C, SyntaxKind::FORCE_C, SyntaxKind::HANDLE_C, SyntaxKind::LAM_C, SyntaxKind::LET_C, SyntaxKind::PAREN_C, SyntaxKind::PERFORM_C, SyntaxKind::RET_C, SyntaxKind::SEL_C, SyntaxKind::TRY_C], 0) { Some(n) => term_of(n), None => atom("#none") }]),
