export const title = "RFC 0048 — Impl elaboration, slice 2: typeclass impls + operator desugaring";

# RFC 0048 — Impl elaboration, slice 2: typeclass impls + operator desugaring
