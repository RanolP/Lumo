export const title = "RFC 0039 — M2 scope: core + data/match + capability rows, judgments on MIR";

# RFC 0039 — M2 scope: core + data/match + capability rows, judgments on MIR
