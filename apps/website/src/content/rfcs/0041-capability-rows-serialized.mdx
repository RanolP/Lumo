export const title = "RFC 0041 — Capability rows: engine value stays non-syntactic, one serialization";

# RFC 0041 — Capability rows: engine value stays non-syntactic, one serialization
