export const title = "RFC 0031 — Cost model: per-constructor constants, min-tree-cost extraction";

# RFC 0031 — Cost model: per-constructor constants, min-tree-cost extraction
